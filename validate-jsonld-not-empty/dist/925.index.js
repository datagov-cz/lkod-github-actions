...
/* harmony export */ });
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5855);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4889);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8053);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3475);
/* harmony import */ var abort_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1659);
...
if (!globalThis.ReadableStream) {
	try {
		globalThis.ReadableStream = await __webpack_require__.e(/* import() */ 956).then(__webpack_require__.t.bind(__webpack_require__, 956, 19));
	} catch {}
}

const {default: ky, HTTPError, TimeoutError} = await __webpack_require__.e(/* import() */ 502).then(__webpack_require__.bind(__webpack_require__, 7502));
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "K1": () => (/* binding */ writeToStream),
/* harmony export */   "NV": () => (/* binding */ getTotalBytes),
/* harmony export */   "Vl": () => (/* binding */ extractContentType),
/* harmony export */   "ZP": () => (/* binding */ Body),
/* harmony export */   "d9": () => (/* binding */ clone)
/* harmony export */ });
/* harmony import */ var node_stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4492);
/* harmony import */ var node_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7261);
/* harmony import */ var node_buffer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2254);
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1410);
/* harmony import */ var formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8010);
/* harmony import */ var _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(2052);
/* harmony import */ var _errors_base_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2588);
/* harmony import */ var _utils_is_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3856);
...
class Body {
	constructor(body, {
		...
		if (body === null) {
			...
			body = null;
		} else if ((0,_utils_is_js__WEBPACK_IMPORTED_MODULE_5__/* .isURLSearchParameters */ .SB)(body)) {
			// Body is a URLSearchParams
			body = node_buffer__WEBPACK_IMPORTED_MODULE_2__.Buffer.from(body.toString());
		} else if ((0,_utils_is_js__WEBPACK_IMPORTED_MODULE_5__/* .isBlob */ .Lj)(body)) {
			// Body is blob
			...
			// Body is stream
		} else if (body instanceof formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_4__/* .FormData */ .Ct) {
			// Body is FormData
			body = (0,formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_4__/* .formDataToBlob */ .au)(body);
		...
		if (body instanceof node_stream__WEBPACK_IMPORTED_MODULE_0__) {
			body.on('error', error_ => {
				const error = error_ instanceof _errors_base_js__WEBPACK_IMPORTED_MODULE_6__/* .FetchBaseError */ .f ?
					error_ :
					new _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__/* .FetchError */ .k(`Invalid response body while trying to fetch ${this.url}: ${error_.message}`, 'system', error_);
	...
	async formData() {
		...
		if (ct.startsWith('application/x-www-form-urlencoded')) {
			const formData = new formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_4__/* .FormData */ .Ct();
	...
	async blob() {
		...
		return new fetch_blob__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z([buf], {
			type: ct
		});
	}
...
async function consumeBody(data) {
	...
	try {
		for await (const chunk of body) {
			if (data.size > 0 && accumBytes + chunk.length > data.size) {
				const error = new _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__/* .FetchError */ .k(`content size at ${data.url} over limit: ${data.size}`, 'max-size');
				body.destroy(error);
				throw error;
			}
		...
		const error_ = error instanceof _errors_base_js__WEBPACK_IMPORTED_MODULE_6__/* .FetchBaseError */ .f ? error : new _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__/* .FetchError */ .k(`Invalid response body while trying to fetch ${data.url}: ${error.message}`, 'system', error);
		throw error_;
	}
	...
	if (body.readableEnded === true || body._readableState.ended === true) {
		try {
			...
			throw new _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__/* .FetchError */ .k(`Could not create Buffer from response body for ${data.url}: ${error.message}`, 'system', error);
		}
	} else {
		throw new _errors_fetch_error_js__WEBPACK_IMPORTED_MODULE_7__/* .FetchError */ .k(`Premature close of server response while trying to fetch ${data.url}`);
	}
}
...
const extractContentType = (body, request) => {
	...
	// Body is a URLSearchParams
	if ((0,_utils_is_js__WEBPACK_IMPORTED_MODULE_5__/* .isURLSearchParameters */ .SB)(body)) {
		return 'application/x-www-form-urlencoded;charset=UTF-8';
	}

	// Body is blob
	if ((0,_utils_is_js__WEBPACK_IMPORTED_MODULE_5__/* .isBlob */ .Lj)(body)) {
	...
	if (body instanceof formdata_polyfill_esm_min_js__WEBPACK_IMPORTED_MODULE_4__/* .FormData */ .Ct) {
...
/* harmony export */ });
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2588);
...
/* harmony import */ var node_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8849);
/**
 * Headers.js
 *
...
var is_redirect = __webpack_require__(3271);
...
var is = __webpack_require__(3856);
// EXTERNAL MODULE: ./node_modules/node-fetch/src/utils/referrer.js
var referrer = __webpack_require__(8893);
...
async function fetch(url, options_) {
	return new Promise((resolve, reject) => {
		...
		const {parsedURL, options} = (0,src_request/* getNodeRequestOptions */.R)(request);
		...
		request_.on('error', error => {
			reject(new fetch_error/* FetchError */.k(`request to ${request.url} failed, reason: ${error.message}`, 'system', error));
			finalize();
		});
			...
			if ((0,is_redirect/* isRedirect */.x)(response_.statusCode)) {
				...
				try {
					...
					if (request.redirect !== 'manual') {
						reject(new fetch_error/* FetchError */.k(`uri requested responds with an invalid redirect URL: ${location}`, 'invalid-redirect'));
						finalize();
						return;
					}
				}
				...
				switch (request.redirect) {
					...
					case 'follow': {
						...
						const requestOptions = {
							...
							body: (0,src_body/* clone */.d9)(request),
						...
						if (!(0,is/* isDomainOrSubdomain */.JN)(request.url, locationURL) || !(0,is/* isSameProtocol */.eL)(request.url, locationURL)) {
						...
						const responseReferrerPolicy = (0,referrer/* parseReferrerPolicyFromHeader */.Cc)(headers);
		...
		(0,src_body/* writeToStream */.K1)(request_, request).catch(reject);
	});
}
...
var src_headers = __webpack_require__(4889);
// EXTERNAL MODULE: ./node_modules/node-fetch/src/body.js
var body = __webpack_require__(251);
// EXTERNAL MODULE: ./node_modules/node-fetch/src/utils/is.js
var is = __webpack_require__(3856);
...
class Request extends body/* default */.ZP {
	...
	/** @returns {string} */
	get url() {
		return (0,external_node_url_.format)(this[INTERNALS].parsedURL);
	}
	...
	set referrerPolicy(referrerPolicy) {
		this[INTERNALS].referrerPolicy = (0,referrer/* validateReferrerPolicy */.vr)(referrerPolicy);
	}
...
const getNodeRequestOptions = request => {
	...
	if (request.referrerPolicy === '') {
		request.referrerPolicy = referrer/* DEFAULT_REFERRER_POLICY */.Cs;
	}
	...
	if (request.referrer && request.referrer !== 'no-referrer') {
		request[INTERNALS].referrer = (0,referrer/* determineRequestsReferrer */.HH)(request);
	} else {
...
/* harmony export */ });
/* harmony import */ var _headers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4889);
/* harmony import */ var _body_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(251);
/* harmony import */ var _utils_is_redirect_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3271);
/**
 * Response.js
 *
...
class Response extends _body_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .ZP {
	constructor(body = null, options = {}) {
		...
		if (body !== null && !headers.has('Content-Type')) {
			const contentType = (0,_body_js__WEBPACK_IMPORTED_MODULE_0__/* .extractContentType */ .Vl)(body, this);
			if (contentType) {
	...
	static json(data = undefined, init = {}) {
		...
		const headers = new _headers_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z(init && init.headers);
...
/* harmony export */   "eL": () => (/* binding */ isSameProtocol)
/* harmony export */ });
/**
 * Is.js
 *
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Cc": () => (/* binding */ parseReferrerPolicyFromHeader),
/* harmony export */   "Cs": () => (/* binding */ DEFAULT_REFERRER_POLICY),
/* harmony export */   "HH": () => (/* binding */ determineRequestsReferrer),
/* harmony export */   "vr": () => (/* binding */ validateReferrerPolicy)
/* harmony export */ });
...
/* harmony import */ var node_net__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7503);
