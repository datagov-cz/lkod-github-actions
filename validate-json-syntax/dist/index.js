...
const action = __webpack_require__(716);
...
const fileSystem = __webpack_require__(747);
const jsonlint = __webpack_require__(744);
...
exports.main = function commonjsMain(args) {
    ...
    if (typeof process !== 'undefined') {
        var source = __webpack_require__(747).readFileSync(__webpack_require__(622).join(process.cwd(), args[1]), "utf8");
    } else {
        var cwd = __webpack_require__(405).path(__webpack_require__(405).cwd());
