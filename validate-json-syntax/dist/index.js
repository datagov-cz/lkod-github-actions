...
const fileSystem = __nccwpck_require__(147);
const jsonlint = __nccwpck_require__(359);
...
exports.main = function commonjsMain(args) {
    ...
    if (typeof process !== 'undefined') {
        var source = (__nccwpck_require__(147).readFileSync)((__nccwpck_require__(17).join)(process.cwd(), args[1]), "utf8");
    } else {
        var cwd = (__nccwpck_require__(721).path)((__nccwpck_require__(721).cwd)());
...
module.exports = eval("require")("file");
...
const action = __nccwpck_require__(117);
